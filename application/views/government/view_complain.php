                                                    ...
                                                    <td><?php echo $com->user_id?></td>
                                                      ...
                                                      <td>
                                                           ...
                                                           <a href="<?php echo base_url();?>welcome/view_complain/<?php echo $com->complain_id?>">
                                                             <button type="button" class="btn btn-info waves-effect waves-light"><i class="mdi mdi-eye" style="float:right" title="View"></i></button>
                                                           </a>&nbsp;
                                    ...
                                    <div class="card m-b-20">
                                        <div class="card-block">
                                            ...
                                            <table id="datatable-buttons" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                                ...
                                                <tbody>
                                                    <?php $i=1?>
                                                 <?php foreach($all_complain_info as $com_info) { ?>   
                                               <tr>
                                                    <td><?php  
                                                           
                                                          $newtext = wordwrap($com_info->complain, 120, "<br />\n");
